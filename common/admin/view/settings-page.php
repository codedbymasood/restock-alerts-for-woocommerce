...
add_action(
	...
	function () {
		$fields = array(
			...
			esc_html__( 'General Settings', 'restock-alerts-for-woocommerce' ) => array(
				array(
					'id'      => 'restaler_show_signup_message',
					'label'   => esc_html__( 'Show Signup Message', 'restock-alerts-for-woocommerce' ),
					'type'    => 'checkbox',
					'default' => '0',
				),
				array(
					'id'      => 'restaler_signup_message',
					'label'   => esc_html__( 'Signup Message', 'restock-alerts-for-woocommerce' ),
					'type'    => 'text',
					'default' => esc_html__( 'Want a reminder when more arrives? Sign up below.', 'restock-alerts-for-woocommerce' ),
				),
				array(
					'id'      => 'restaler_enable_stock_threshold',
					'label'   => esc_html__( 'Stock Threshold', 'restock-alerts-for-woocommerce' ),
					'type'    => 'checkbox',
					'default' => '0',
				),
				array(
					'id'      => 'restaler_stock_threshold_count',
					'label'   => esc_html__( 'Stock Threshold Count', 'restock-alerts-for-woocommerce' ),
					'type'    => 'number',
					'default' => 3,
				),
			),
