...
class Admin {
	...
	private function __construct() {
		add_filter(
			...
			function ( $plugins = array() ) {
				$plugins[] = 'restock-alerts-for-woocommerce';
	...
	public function bulk_actions( $actions = array() ) {
		$actions['export_csv'] = esc_html__( 'Export to CSV', 'restock-alerts-for-woocommerce' );
		return $actions;
	}
	...
	public function csv_export_columns() {
		return array(
			...
			'product_id'   => esc_html__( 'Product', 'restock-alerts-for-woocommerce' ),
			'variation_id' => esc_html__( 'Variation', 'restock-alerts-for-woocommerce' ),
