...
class Admin {
    ...
    // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
		...
		wp_send_json_success(
			array(
				'message' => esc_html__( 'Settings saved!', 'restock-alerts-for-woocommerce' ),
			)
		);
	...
	public function admin_menu() {
		...
		add_menu_page(
			esc_html__( 'Store Boost Kit', 'restock-alerts-for-woocommerce' ),
			esc_html__( 'Store Boost Kit', 'restock-alerts-for-woocommerce' ),
			'manage_woocommerce',
			'stobokit-dashboard',
		...
		add_submenu_page(
			'stobokit-dashboard',
			esc_html__( 'Dashboard', 'restock-alerts-for-woocommerce' ),
			esc_html__( 'Dashboard', 'restock-alerts-for-woocommerce' ),
			'manage_woocommerce',
			'stobokit-dashboard',
			array( $this, 'dashboard' )
		...
		add_submenu_page(
			'stobokit-dashboard',
			esc_html__( 'Status', 'restock-alerts-for-woocommerce' ),
			esc_html__( 'Status', 'restock-alerts-for-woocommerce' ),
			'manage_woocommerce',
			'stobokit-status',
			array( $this, 'status' )
		...
		if ( ! empty( $product_lists ) ) {
			add_submenu_page(
				'stobokit-dashboard',
				esc_html__( 'License', 'restock-alerts-for-woocommerce' ),
				esc_html__( 'License', 'restock-alerts-for-woocommerce' ),
				'manage_woocommerce',
				'stobokit-license',
				array( $this, 'license' )
