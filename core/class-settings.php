		...
		<div class="stobokit-wrapper wrap">
			...
			if ( isset( $_GET['settings-updated'] ) ) :
				...
				<div class="stobokit-notice">
					<p><?php esc_html_e( 'Settings saved successfully!', 'restock-alerts-for-woocommerce' ); ?></p>
				</div>
				<?php
			endif;
			?>
			...
			<div class="nav-tab-wrapper horizontal">
				...
				<div class="nav-tab-content-wrapper">
					<form method="post">
						...
						<?php endforeach; ?>
						<?php submit_button( esc_html__( 'Save Settings', 'restock-alerts-for-woocommerce' ) ); ?>
					</form>
				</div>
			</div>
		</div>
