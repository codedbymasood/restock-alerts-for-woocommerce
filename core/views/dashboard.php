...
<div class="stobokit-wrapper no-spacing">
	<div class="wrap">
		<h2><?php esc_html_e( 'Welcome to Store Boost Kit', 'restock-alerts-for-woocommerce' ); ?></h2>

		<div class="stobokit-widgets">

			<!-- Quick Links Widget -->
			<div class="stobokit-widget">
					<h3><?php esc_html_e( 'Quick Links', 'restock-alerts-for-woocommerce' ); ?></h3>
					<ul>
							<li><a href="https://storeboostkit.com/support-form" target="_blank"><?php esc_html_e( 'Support', 'restock-alerts-for-woocommerce' ); ?></a></li>
							<li><a href="https://help.storeboostkit.com" target="_blank"><?php esc_html_e( 'Help Desk', 'restock-alerts-for-woocommerce' ); ?></a></li>
							<li><a href="https://storeboostkit.com/frequently-asked-questions" target="_blank"><?php esc_html_e( 'FAQ', 'restock-alerts-for-woocommerce' ); ?></a></li>
							<li><a href="https://storeboostkit.com/account" target="_blank"><?php esc_html_e( 'My Account', 'restock-alerts-for-woocommerce' ); ?></a></li>
					</ul>
			</div>
			...
			if ( ! empty( $product_lists ) ) {
				...
				<!-- Licenses Widget -->
				<div class="stobokit-widget">
					<h3><?php esc_html_e( 'Licenses', 'restock-alerts-for-woocommerce' ); ?></h3>
					<?php
					$inactive_count = 0;
					$expired_count  = 0;
					...
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=stobokit-license' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Manage Licenses', 'restock-alerts-for-woocommerce' ); ?></a>
				</div>
				<?php
			}
			?>
			...
			<?php if ( ! empty( $recent_posts ) ) : ?>
				<div class="stobokit-widget">
					<h3><?php esc_html_e( 'News & Updates', 'restock-alerts-for-woocommerce' ); ?></h3>
					<ul>
			...
			<?php if ( ! empty( $announcement_posts ) ) : ?>
				<div class="stobokit-widget">
					<h3><?php esc_html_e( 'Announcements & Promotions', 'restock-alerts-for-woocommerce' ); ?></h3>
					<ul>
						<?php
