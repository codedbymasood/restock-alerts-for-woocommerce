...
class Plugin_Updater {
	...
	public function show_update_notification( $file, $plugin ) {
		...
		printf(
			...
			esc_html__( 'There is a new version of %1$s available.', 'restock-alerts-for-woocommerce' ),
			esc_html( $plugin['Name'] )
		);

		if ( ! current_user_can( 'update_plugins' ) ) {
			echo ' ';
			esc_html_e( 'Contact your network administrator to install the update.', 'restock-alerts-for-woocommerce' );
			...
			printf(
				...
				esc_url( wp_nonce_url( $update_link, 'upgrade-plugin_' . $file ) ),
				esc_html__( 'Update now.', 'restock-alerts-for-woocommerce' )
			);
		}
	...
	public function show_changelog() {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			wp_die( esc_html__( 'You do not have permission to install plugin updates', 'restock-alerts-for-woocommerce' ), esc_html__( 'Error', 'restock-alerts-for-woocommerce' ), array( 'response' => 403 ) );
		}
